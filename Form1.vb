...
Public Class Form1
    ...
    Private Sub PanelAttendance_Paint(sender As Object, e As PaintEventArgs) Handles PanelAttendance.Paint
        e.Graphics.DrawRectangle(New Pen(Color.LightGray, 2), PanelConnection.ClientRectangle)
    End Sub

    Private Sub PanelAttendance_Resize(sender As Object, e As EventArgs) Handles PanelAttendance.Resize
        PanelAttendance.Invalidate()
    End Sub
    ...
    'so ito yung sa scan id gagamitin ko rin ito dun sa attendance
    ...
    Private Sub ButtonAttendance_Click(sender As Object, e As EventArgs) Handles ButtonAttendance.Click
        StrSerialIn = ""
        ViewUserData = False
        PictureBoxSelect.Top = ButtonAttendance.Top
        PanelConnection.Visible = True
        PanelUserData.Visible = True
        PanelRegistrationandEditUserData.Visible = True
